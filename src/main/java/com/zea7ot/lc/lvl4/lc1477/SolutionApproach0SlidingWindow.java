 ...
 */
package com.zea7ot.lc.lvl4.lc1477;
...
public class SolutionApproach0SlidingWindow {
    public int minSumOfLengths(int[] nums, int target) { // nums = [3,2,2,4,3], target = 3 
        ...
        for(int e = 0; e < N; e++){ // nums = [3,2,2,4,3], target = 3
            sum += nums[e]; // (e = 0, sum = 3); (e = 1, sum = 5); (e = 2, sum = 4); (e = 3, sum = 6); (e = 4, sum = 3)
            while(sum > target) 
                sum -= nums[s++]; // (s = 0, sum = 3); (s = 1, sum = 2); (s = 2, sum = 2); (s = 3, sum = 4), (s = 4, sum = 0); (s = 4, sum = 2)
            ...
            minLens[e] = minLen;    // minLens[0] = 1; minLen[1] = 1; minLen[2] = 1; minLen[2] = 1; minLen[3] = 1; minLen[4] = 1
        }
