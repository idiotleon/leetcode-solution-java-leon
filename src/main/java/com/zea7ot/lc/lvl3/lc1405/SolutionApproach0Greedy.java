 ...
 */
package com.zea7ot.lc.lvl3.lc1405;
...
public class SolutionApproach0Greedy {
    ...
    private String generate(int a, int b, int c, String aa, String bb, String cc){
        ...
        return String.join("", Collections.nCopies(aUsed, aa)) 
                + String.join("", Collections.nCopies(bUsed, bb))
                + generate(a - aUsed, b - bUsed, c, aa, bb, cc);
        // java 11
        // return aa.repeat(aUsed) + bb.repeat(bUsed) + generate(a - aUsed, b - bUsed, c, aa, bb, cc);
    }
}