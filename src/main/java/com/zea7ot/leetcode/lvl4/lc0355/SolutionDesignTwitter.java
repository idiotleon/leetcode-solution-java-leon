 ...
 */
package com.zea7ot.leetcode.lvl4.lc0355;
...
public class SolutionDesignTwitter {
    ...
    public List<Integer> getNewsFeed(int userId) {
        if(!roster.containsKey(userId)) return new ArrayList<Integer>();
        
        User user = roster.get(userId);
        Set<User> followees = user.followees;
        
        // to grasp ALL tweets from the user himself/herself, as well as all his/hers followees', 
        ...
        while(!minHeap.isEmpty()) ans.addFirst(minHeap.poll().tweetId);
