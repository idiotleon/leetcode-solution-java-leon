...
public class SolutionApproach0TopologicalSort1 {
    ...
    public String alienOrder(String[] words) {
        ...
        final List<Set<Integer>> nextSets = new ArrayList<>();
        for (int i = 0; i < TOTAL_ALPHABETS; ++i) {
            nextSets.add(new HashSet<>());
        }

        final int[] counts = new int[TOTAL_ALPHABETS];
        ...
        for (int i = 0; i < N; ++i) {
            ...
            final String prevWord = words[i - 1], curWord = words[i];
